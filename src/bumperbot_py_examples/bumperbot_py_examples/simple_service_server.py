...
class SimpleServerService(Node):
    def __init__(self):
        super().__init__("simple_server_service")
    ...
    def serviceCallback(self, req, res):
        self.get_logger().info("New request received: %d and %d" % (req.a, req.b))
        res.sum = req.a+req.b
...
def main():
    rclpy.init()
    simple_service_server = SimpleServerService()
