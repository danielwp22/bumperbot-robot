...
class SimpleController(Node):
    ...
    def jointCallback(self, msg):
        ...
        self.get_logger().info(f"THIS IS SIMPLE fi_left: {fi_left}")
        ...
        self.get_logger().info(f"THIS IS SIMPLE ANGULAR: {angular}")
        self.get_logger().info(f"THIS IS NEGATIVE SIMPLE ANGULAR: {angular}")
